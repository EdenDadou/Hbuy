...
import { Text, FooterTab, View, Button } from 'native-base';
import { StyleSheet, Image, ScrollView, Dimensions, Modal, TouchableOpacity } from 'react-native'
import { LinearGradient } from 'expo-linear-gradient';
import _NewsList from './Elements/News/_NewsList';
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <LinearGradient colors={['#1e3d42', '#020506']} style={{ flex: 1 }}>
          <ScrollView>

            <_NewsList navigation={this.props.navigation} />
        ...
        <LinearGradient colors={['#20554f', '#020506']} style={{ height: 70 }}>
          <FooterTab>
            <Button vertical  active onPress={() => this.props.navigation.navigate('News')}>
              ...
              <Text style={{color: '#20554f', fontSize: 9}}>{translate("NEWS_TITLE", this.props.Locale)}</Text>
            </Button>
...
export default
  connect(mapStateToProps, { UserLogout, ChangeLocale })(News);